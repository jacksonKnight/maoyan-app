<template>
  <div class="detail">
    <div class="detail-top">
      <span class="iconfont icon-zuojiantou" @click="duck"></span>
      <span>猫眼电影</span>
    </div>
    <div class="detail-nav">
      <div class="detail-nav-left">
        <div class="detail-nav-img">
          <img :src="videoes.images.small" class="auto-img" alt />
          <!-- {{movies}} -->
        </div>
        <div class="detail-rig">
          <div @click="aaa">{{videoes.title}}</div>
          <div>{{videoes.original_title}}</div>
          <div>
            <span>{{videoes.rating.average}}&nbsp;&nbsp;</span>
            <span>({{videoes.rating.stars}}万人评)</span>
          </div>
          <div>{{getGenres(videoes.genres)}}</div>
          <div>{{videoes.durations[1]}}</div>
